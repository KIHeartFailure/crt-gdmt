...
rasiarni <- fufunc_inner(rsdata_fu, medvar = "rasiarnidiff_cat2")
rasiarni_exarni <- fufunc_inner(rsdata_fu, medvar = "rasiarnidiff_exarni_cat2")
mra <- fufunc_inner(rsdata_fu, medvar = "mradiff_cat2")
bbl <- fufunc_inner(rsdata_fu, medvar = "bbldiff_cat2")
loop <- fufunc_inner(rsdata_fu, medvar = "loopdiff_inccat2")
