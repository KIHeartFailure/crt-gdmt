...
predictorsfunc <- function(medvar, impdata = imprsdata) {
  modvarstmp <- c("sos_lm_bbl1_3", "sos_lm_rasiarni1_3", "sos_lm_mra1_3", "sos_lm_loop1_3", modvars)
  ...
  predout <- left_join(predout,
    ...
    mutate(
      ...
      var = case_when(
        ...
        var == "indexyear_cat2019-2022" ~ "Year 2019-2022 vs 2009-2013",
        ...
        var == "sos_durationhf_cat10-18" ~ "Duration of HF (months) 10-18 vs 3-9",
        var == "sos_durationhf_cat>=19" ~ "Duration of HF (months) >=19 vs 3-9",
        TRUE ~ var
      ),
...
predictorsfunc(medvar = "bbldiff_cat2")
```
...
predictorsfunc(medvar = "rasiarnidiff_cat2")
```
...
predictorsfunc(medvar = "mradiff_cat2")
```
