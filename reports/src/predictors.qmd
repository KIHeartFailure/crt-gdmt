...
predictorsfunc <- function(medvar, impdata = imprsdata, novars = NULL) {
  ...
  for (i in seq_along(modvarstmp)) {
    ...
    for (j in seq_along(levcrt)) {
      logreg <- with(impdata, glm(formula(paste0(medvar, " == 'Increase' ~ ", modvarstmp[i], " * relevel(crt, ref = '", levcrt[j], "') + ", paste(setdiff(modvarstmp, modvarstmp[i]), collapse = " + "))),
  ...
  predout <- left_join(predout,
    ...
    mutate(
      ...
      var = case_when(
        var == "indexyear_cat2014-2018" ~ "Year 2014-2018 vs 2009-2013",
        var == "indexyear_cat2019-2023" ~ "Year 2019-2023 vs 2009-2013",
        ...
        var == "sos_lm_mra1_3>=50" ~ "MRA TD (%) >=50 vs No",
        var == "sos_lm_loop1_3<=40" ~ "Loop diuretic FE (mg) <=40 vs No",
        var == "sos_lm_loop1_3>40" ~ "Loop diuretic FE (mg) >40 vs No",
        ...
        var == "shf_bpsys_cat>=110" ~ "Systolic bp (mmHg) >=110 vs <110",
        var == "shf_heartrate_cat>60" ~ "Heart rate (beats/min) >60 vs <=60",
        var == "shf_gfrckdepi_cat<60" ~ "eGFR (mL/min/1.73 m²) <60 vs >=60",
        var == "shf_ntprobnp_cat3rd tertile" ~ "NT-proBNP (pg/ml) 3rd vs 1st tertile",
        var == "shf_ntprobnp_cat2nd tertile" ~ "NT-proBNP (pg/ml) 2nd vs 1st tertile",
        TRUE ~ var
      ),
...
```{r}
#| label: fig-predictors-combined-hypobp
#| cache: true
#| cache.comments: false
#| dependson: predictorsfunc
#| fig-cap: "Associations between baseline characteristics and increase in Combined - systolic blood pressure < 110 (mmHg)"
#| fig-width: 10
#| fig-height: 10

predictorsfunc(medvar = "gdmtdiff_cat2", impdata = imprsdatahypo, novars = "shf_bpsys_cat")
```

```{r}
#| label: fig-predictors-bbl-hypobp
#| cache: true
#| cache.comments: false
#| dependson: predictorsfunc
#| fig-cap: "Associations between baseline characteristics and increase in Beta-blocker - systolic blood pressure < 110 (mmHg)"
#| fig-width: 10
#| fig-height: 10

predictorsfunc(medvar = "bbldiff2", impdata = imprsdatahypo, novars = "shf_bpsys_cat")
```

```{r}
#| label: fig-predictors-rasiarni-hypobp
#| cache: true
#| cache.comments: false
#| dependson: predictorsfunc
#| fig-cap: "Associations between baseline characteristics and increase in ACEi/ARB/ARNi - systolic blood pressure < 110 (mmHg)"
#| fig-width: 10
#| fig-height: 10

predictorsfunc(medvar = "rasiarnidiff2", impdata = imprsdatahypo, novars = "shf_bpsys_cat")
```

```{r}
#| label: fig-predictors-mra-hypobp
#| cache: true
#| cache.comments: false
#| dependson: predictorsfunc
#| fig-cap: "Associations between baseline characteristics and increase in MRA - systolic blood pressure < 110 (mmHg)"
#| fig-width: 10
#| fig-height: 10

predictorsfunc(medvar = "mradiff2", impdata = imprsdatahypo, novars = "shf_bpsys_cat")
```

```{r}
#| label: fig-predictors-combined-normobp
#| cache: true
#| cache.comments: false
#| dependson: predictorsfunc
#| fig-cap: "Associations between baseline characteristics and increase in Combined - systolic blood pressure >= 110 (mmHg)"
...
predictorsfunc(medvar = "gdmtdiff_cat2", impdata = imprsdatanormo, novars = "shf_bpsys_cat")
```

```{r}
#| label: fig-predictors-bbl-normobp
#| cache: true
#| cache.comments: false
#| dependson: predictorsfunc
#| fig-cap: "Associations between baseline characteristics and increase in Beta-blocker - systolic blood pressure >= 110 (mmHg)"
...
predictorsfunc(medvar = "bbldiff2", impdata = imprsdatanormo, novars = "shf_bpsys_cat")
```

```{r}
#| label: fig-predictors-rasiarni-normobp
#| cache: true
#| cache.comments: false
#| dependson: predictorsfunc
#| fig-cap: "Associations between baseline characteristics and increase in ACEi/ARB/ARNi - systolic blood pressure >= 110 (mmHg)"
...
predictorsfunc(medvar = "rasiarnidiff2", impdata = imprsdatanormo, novars = "shf_bpsys_cat")
```

```{r}
#| label: fig-predictors-mra-normobp
#| cache: true
#| cache.comments: false
#| dependson: predictorsfunc
#| fig-cap: "Associations between baseline characteristics and increase in MRA - systolic blood pressure >= 110 (mmHg)"
...
predictorsfunc(medvar = "mradiff2", impdata = imprsdatanormo, novars = "shf_bpsys_cat")
```
