...
#| tbl-cap: "Use of GDMT & loop diuretic"
...
#| cache.comments: false
#| dependson: medtabfunc
#| tbl-cap: "Use of GDMT & loop diuretic - systolic blood pressure < 110 (mmHg)"

medtabfunc(data = rsdata %>% filter(shf_bpsys_cat == "<110"))
```

```{r}
#| label: tbl-med-normobp
#| cache: true
#| cache.comments: false
#| dependson: medtabfunc
#| tbl-cap: "Use of GDMT & loop diuretic - systolic blood pressure >= 110 (mmHg)"
