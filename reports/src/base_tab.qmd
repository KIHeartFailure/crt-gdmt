...
basetabfunc <- function(data, novars = NULL) {
  ...
  tab <- left_join(tab,
    ...
    mutate(
      ...
      pmis = if_else(var %in% c("absdiff_crt_shf", "diff_crt_shf_cat"), "0", pmis)
    )
...
```{r}
#| label: tbl-base-durhf1
#| cache: true
#| cache.comments: false
#| dependson: basetabfunc
#| tbl-cap: "Baseline characteristics - duration of HF 3-9 (months)"
#| tbl-pos: "H"

basetabfunc(data = rsdata %>% filter(sos_durationhf_cat == "3-9"), novars = "sos_durationhf_cat")
```

```{r}
#| label: tbl-base-durhf2
#| cache: true
#| cache.comments: false
#| dependson: basetabfunc
#| tbl-cap: "Baseline characteristics - duration of HF 10-18 (months)"
#| tbl-pos: "H"

basetabfunc(data = rsdata %>% filter(sos_durationhf_cat == "10-18"), novars = "sos_durationhf_cat")
```

```{r}
#| label: tbl-base-durhf3
#| cache: true
#| cache.comments: false
#| dependson: basetabfunc
#| tbl-cap: "Baseline characteristics - duration of HF >= 19 (months)"
#| tbl-pos: "H"

basetabfunc(data = rsdata %>% filter(sos_durationhf_cat == ">=19"), novars = "sos_durationhf_cat")
```
