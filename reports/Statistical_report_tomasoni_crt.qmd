...
codes I50.0, I50.1, I50.9, I42.0, I42.6, I42.7, I25.5, I11.0, I13.0, I13.2. In 2021, 69 of 76 Swedish hospitals enrolled patients in SwedeHF, which had a 32% coverage of the prevalent HF population in Sweden[@annualreport]. For this project SHFDB version 4.2.0 was used, see https://kiheartfailure.github.io/shfdb4/. SwedeHF provided information on planned follow-up and the controls. 
...
The study was approved by the Swedish Ethical Review Authority, dnr 2021-04326, add amendment dnr. 
...
First patient in: `r min(rsdata$indexdtm)` and last patient in: `r max(rsdata$indexdtm)`. 
