...
codes I50.0, I50.1, I50.9, I42.0, I42.6, I42.7, I25.5, I11.0, I13.0, I13.2. In 2021, 69 of 76 Swedish hospitals enrolled patients in SwedeHF, which had a 32% coverage of the prevalent HF population in Sweden[@annualreport]. For this project SHFDB version 4.1.2 was used, see https://kiheartfailure.github.io/shfdb4/. SwedeHF provided information on planned follow-up and the controls. 
...
For the models No change and Decrease where combined into one catgory forming a dichomonous variable Increase vs. No change/Decrease. 
...
The association between CRT compared to No CRT (controls) and increase in the individual GDMT as well as the combined GDMT was evaluated using logistic regression models. 
Partly crude, partly adjusting for the respective baseline medication (for increase in the combined GDMT variable all 3 baseline medications were adjusted for) and partly adjusting for all variables indicated in @tbl-base together with the baseline medications. 
